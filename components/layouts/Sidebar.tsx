...
import { Home, Toolbox, User, NotebookPen, Mail, LucideProps } from "lucide-react"
 ...
 */
const items:{title:string, url:string, icon: ForwardRefExoticComponent<Omit<LucideProps, "ref"> & RefAttributes<SVGSVGElement>>}[] = [
 ...
 */
export function PortfolioSidebar({ className }: { className?: string }):React.JSX.Element {
  // Brings in the use pathname hook for use
              ...
              <SidebarGroup>
                  <SidebarGroupContent>
                      <SidebarMenu className="gap-1">
                          {items.map((item:{title:string, url:string, icon: ForwardRefExoticComponent<Omit<LucideProps, "ref"> & RefAttributes<SVGSVGElement>>}) => {
